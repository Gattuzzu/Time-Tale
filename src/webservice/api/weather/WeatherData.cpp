...
// Beispiel für printToSerial() - auskommentiert, wie in deiner Vorlage
/*
// Optional: Hilfsfunktion, um den Enum-Wert als String auszugeben (für Debugging)
...
void WeatherData::printToSerial() {
    ...
    Serial.print("Temperature: "); Serial.print(temperature.degrees); Serial.println(temperature.unit);
    Serial.print("Relative Humidity: "); Serial.println(relativeHumidity);
    Serial.print("Weather Type: "); Serial.println(weatherConditionTypeToString(weatherType));
